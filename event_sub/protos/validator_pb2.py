...
_MESSAGE_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONSENSUS_NOTIFY_ENGINE_ACTIVATED', index=116, number=907,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONSENSUS_NOTIFY_ENGINE_DEACTIVATED', index=117, number=908,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CONSENSUS_NOTIFY_ACK', index=118, number=999,
      serialized_options=None,
      type=None),
  ],
